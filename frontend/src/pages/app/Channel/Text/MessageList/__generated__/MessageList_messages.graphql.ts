...
export type MessageList_messages = {
    readonly messages: {
...
export type MessageList_messages$key = {
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./MessageListPaginationQuery.graphql.ts'),
      "identifierField": "id"
    }
  },
...
(node as any).hash = '2fe7d9524c1a400a98311be5fc39d226';
export default node;
